...
@CucumberOptions(features = {"src/test/resources/features/iconnect/smoke/Smoke_Iconnect.feature"},
        monochrome = true,
        tags = {"@Smoke1"},
        glue = {"iconnect"},
...
public class IconnectCukes extends AbstractTestNGCucumberTests {
