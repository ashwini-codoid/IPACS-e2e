...
public class DriverUtil {
    ...
    public static WebDriver getWinAppDriver(DesiredCapabilities capability) {
        ...
        try {
            ...
            System.out.println(">>strRemoteIP" + strRemoteIP + ">>strRemotePort");
...
//            driver = new WindowsDriver(new URL("http://127.0.0.1:4723"), capability);
    ...
    public static WebDriver getAppiumDriver(DesiredCapabilities capability) {
        ...
        try {
            ...
            //  System.out.println(Constants.SMARTWAY2_MOBILE_APK_NAME1);
            System.out.println(">>>> STR URL :: " + strURL);
            System.out.println(">>>> Caps :: " + capability);
            System.out.println("\n >>>>> Before Android Driver  URL :: ");
    ...
    public static WebDriver getRemoteDriver() {
        ...
        try {
            String strBrowser = System.getProperty(Constants.ENV_VARIABLE_BROWSER_NAME, "");
            String strRemoteURL = new StringBuilder().append("http://")
                    .append(getRemoteIP()).append(":")
                    .append(getRemotePort()).append("/wd/hub")
                    .toString();
            ...
            driver = new RemoteWebDriver(new URL(strRemoteURL), caps);
        } catch (Exception e) {
        }
        return driver;
    }
    ...
    public static String getRemoteIP() {
        String strRemoteIP;
        try {
            strRemoteIP = System.getProperties().get(Constants.REMOTE_IP)
                    .toString();
        } catch (Exception e) {
    ...
    public static String getRemotePort() {
        ...
        try {
            strRemotePort = System.getProperties().get(Constants.REMOTE_PORT)
                    .toString();
        } catch (Exception e) {
            strRemotePort = "4444";
        }
